...
export default function OnboardingScreen({ onStart, coverImageUrl = '/cover.png' }: OnboardingScreenProps) {
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col" style={{ marginTop: '62px', gap: '32px' }}>
        {/* Heading */}
        <h1 style={{ fontFamily: 'Inter, sans-serif', fontSize: '66px', fontWeight: 400, letterSpacing: '-1.32px', color: '#201515', lineHeight: 1 }}>
          Find your ITSM fit
        </h1>

        {/* Subheading */}
        <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '18px', fontWeight: 400, letterSpacing: '-0.072px', color: '#000000', lineHeight: 1.5 }}>
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Text */}
          <span style={{ fontFamily: 'Inter, sans-serif', fontSize: '16px', fontWeight: 400, color: '#201515', lineHeight: 1 }}>Takes 2 mins</span>
        </div>
      </div>
